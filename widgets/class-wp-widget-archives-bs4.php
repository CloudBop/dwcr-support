 ...
 * @since 4.4.0
 */
function add_bootstrap4_list_group_item( $link_html ) {
 ...
 * @see WP_Widget
 */
class WP_Widget_Archives_BS4 extends WP_Widget {
	...
	public function __construct() {
      ...
      'before'                      => "<li class='test2'>",
      'after'                       => "</li>"
		);
		parent::__construct( 'archives-bs4', __( 'Archives BS4' ), $widget_ops );
	}
    ...
    //overrule default wordpress args
...
/* ]]> */
			...
			<ul class="list-group list-group-flush mx-1">
				<?php
        //  add bs4 - remember to remove thus filter...
        add_filter( 'get_archives_link', 'add_bootstrap4_list_group_item' );
				...
				wp_get_archives(
					...
					apply_filters(
						...
						array(
							'type'            => 'monthly',
							'show_post_count' => $count,
              // 'before' => "<li class='test'>",
              // 'after' => "</li>"
						),
						$instance
					)
				);
        remove_filter( 'get_archives_link', 'add_bootstrap4_list_group_item' );
				?>
			</ul>
