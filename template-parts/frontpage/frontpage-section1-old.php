<?php
// DATA FROM ACF || or echo out in  mkup
  ...
  <div class="container">
      <div class="row">
          <div class="col-12 col-lg-6">
              <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong><?php echo get_field('section1_title'); ?></strong></h1>
              <p class="mbr-text mbr-fonts-style display-7">
                <?php echo get_field('section1_title'); ?>
              </p>
              <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4" href="#"> <?php echo get_field('section1_title'); ?> </a>
              </div>
          </div>
      </div>
  </div>
